...
`,N=o('<img class="backgroundNote" src="./music-note.png">'),P=o('<span class="green">PLAY</span>'),z=o('<div id="mainContent"></div>'),$=o('<div id="sidebar"></div>');const A=()=>[N.cloneNode(!0),N.cloneNode(!0),N.cloneNode(!0),n(y,{get children(){return["Re",P.cloneNode(!0)]}}),n(h,{get children(){return[(()=>{const e=z.cloneNode(!0);return r(e,n(x,{children:"Backup this weeks discover weekly!"}),null),r(e,n(b,{children:"You must be following your discover weekly for this tool to work."}),null),r(e,n(u,{get href(){return function(){const e=new URL("https://accounts.spotify.com/authorize");return e.searchParams.append("show_dialog","true"),e.searchParams.append("response_type","token"),e.searchParams.append("client_id","b487c0ac409c4b4aba8703323c9e8305"),e.searchParams.append("redirect_uri","https://chazzox.github.io/RePLAY/"),e.searchParams.append("scope",["playlist-modify-private","playlist-read-private","playlist-modify-public"].join(" ")),e.toString()}()},children:"Login to Spotify"}),null),e})(),(()=>{const e=$.cloneNode(!0);return r(e,n(x,{children:"What is RePLAY?"}),null),r(e,n(b,{children:"Replay is a a simplistic tools that backups your discover weekly at the press of a button!"}),null),r(e,n(b,{children:"For those times you find yourself frequently forgetting to listen to the whole of it and the clock is ticking towards midnight on the final day."}),null),e})()]}})];var E="/RePLAY/assets/music-note.7c6cc88d.png";const j=o('<img class="backgroundNote">'),L=o('<span class="green">PLAY</span>'),R=o('<div id="mainContent"></div>'),S=o('<div id="sidebar"></div>'),B=o("<h2>Save your Discover Weekly</h2>"),D=o('<form><div id="formHeader">Name your Backup:</div></form>'),_=o("<h2>Success!</h2>"),C=[200,201];async function W(e,t){const o=await async function(e){const t=[];let o="https://api.spotify.com/v1/me/playlists?limit=50";for(;o;){const n=await fetch(o,{method:"GET",headers:{Authorization:"Bearer "+e}});if(!C.includes(n.status))throw Error("Playlist fetch Unsuccessful");const r=await n.json();t.push(...r.items),o=r.next}return t}(e);for(const n in o)if(o[n].name===t)return o[n];throw Error("Could not find Discover weekly playlist in followed playlists")}const Y=({token:e})=>{const[t,o]=i(""),[c,l]=i(!1),[d,p]=i("");async function u(e,t){try{const o=await async function(e){const t=await fetch("https://api.spotify.com/v1/me",{method:"GET",headers:{Authorization:"Bearer "+e}});if(!C.includes(t.status))throw Error("Creating new playlist was unsuccessful");return(await t.json()).id}(e),n=await W(e,"Discover Weekly"),r=await async function(e,t){const o=await fetch(t,{method:"GET",headers:{Authorization:"Bearer "+e}}),n=await o.json();if(!C.includes(o.status))throw Error("Fetching Discover weekly tracklist failed");return n.items}(e,n.tracks.href),i=await async function(e,t,o){const n=await fetch(`https://api.spotify.com/v1/users/${t}/playlists`,{method:"POST",headers:{Authorization:"Bearer "+e},body:JSON.stringify({name:o,description:"New playlist description",public:!1})});if(!C.includes(n.status))throw Error("Creating new playlist was unsuccessful");return(await n.json()).id}(e,o,t);await async function(e,t,o){const n=new URL(`https://api.spotify.com/v1/playlists/${t}/tracks`);n.searchParams.append("uris",o.join());const r=await fetch(n.toString(),{method:"POST",headers:{Authorization:"Bearer "+e}});if(!C.includes(r.status))throw Error("Adding songs failed")}(e,i,r.map((e=>e.track.uri))),l(!0)}catch(n){o=n.message,p(""),p(o)}var o}return[(()=>{const e=j.cloneNode(!0);return a(e,"src",E),e})(),(()=>{const e=j.cloneNode(!0);return a(e,"src",E),e})(),(()=>{const e=j.cloneNode(!0);return a(e,"src",E),e})(),n(y,{get children(){return["Re",L.cloneNode(!0)]}}),n(h,{get children(){return[(()=>{const i=R.cloneNode(!0);return r(i,(()=>{const i=s((()=>!c()),!0);return()=>i()?[B.cloneNode(!0),(()=>{const i=D.cloneNode(!0);return i.firstChild,i.addEventListener("submit",(o=>{o.preventDefault(),""!=t()&&u(e,t())})),r(i,n(f,{type:"text",required:!0,placeholder:"New Playlist Name",onInput:e=>{o(e.target.value)},get value(){return t()}}),null),r(i,n(g,{type:"submit",children:"Backup Now"}),null),i})()]:[_.cloneNode(!0),n(x,{children:"Discover Weekly has been saved"})]})(),null),r(i,(()=>{const e=s((()=>""!==d()),!0);return()=>e()&&n(v,{get children(){return d()}})})(),null),i})(),(()=>{const e=S.cloneNode(!0);return r(e,n(x,{children:"What is RePLAY?"}),null),r(e,n(b,{children:"Replay is a a simplistic tools that backups your discover weekly at the press of a button!"}),null),r(e,n(b,{children:"For those times you find yourself frequently forgetting to listen to the whole of it and the clock is ticking towards midnight on the final day."}),null),e})()]}})]};c((()=>{const[e,t]=i("");return l((()=>{document.cookie&&""===window.location.hash&&parseInt(p.get("expiry"))>Date.now()&&t(p.get("access_token"));const e=Object.fromEntries(new URLSearchParams(document.location.hash.slice(1)).entries());e.access_token&&(t(e.access_token),p.set("access_token",e.access_token),p.set("expiry",String(Date.now()+1e3*parseInt(e.expires_in))),history.pushState("",document.title,window.location.pathname+window.location.search))})),n(d,{theme:{black:"#172228",gray:"#dadae2",green:"#1db954",secondaryGreen:"#15883e",white:"#ffffff",offWhite:"#f9f5f2",secondaryBlack:"#181818"},get children(){return[n(m,{}),n(w,{get children(){const t=s((()=>""===e()),!0);return()=>t()?n(A,{}):n(Y,{get token(){return e()}})}})]}})}),document.getElementById("root"));
