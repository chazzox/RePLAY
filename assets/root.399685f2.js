...
`,N=o('<div id="mainContent"></div>');const z=()=>(()=>{const e=N.cloneNode(!0);return n(e,r(x,{children:"Backup this weeks discover weekly!"}),null),n(e,r(b,{children:"You must be following your discover weekly for this tool to work."}),null),n(e,r(u,{get href(){return function(){const e=new URL("https://accounts.spotify.com/authorize");return e.searchParams.append("show_dialog","true"),e.searchParams.append("response_type","token"),e.searchParams.append("client_id","b487c0ac409c4b4aba8703323c9e8305"),e.searchParams.append("redirect_uri","https://chazzox.uk/RePLAY/"),e.searchParams.append("scope",["playlist-modify-private","playlist-read-private","playlist-modify-public"].join(" ")),e.toString()}()},children:"Login to Spotify"}),null),e})(),$=o('<div id="mainContent"></div>'),P=o("<h2>Save your Discover Weekly</h2>"),E=o('<form><div id="formHeader">Name your Backup:</div></form>'),j=o("<h2>Success!</h2>"),S=[200,201];async function B(e,t){const o=await async function(e){const t=[];let o="https://api.spotify.com/v1/me/playlists?limit=50";for(;o;){const n=await fetch(o,{method:"GET",headers:{Authorization:"Bearer "+e}});if(!S.includes(n.status))throw Error("Playlist fetch Unsuccessful");const r=await n.json();t.push(...r.items),o=r.next}return t}(e);for(const n in o)if(o[n].name===t)return o[n];throw Error("Could not find Discover weekly playlist in followed playlists")}const D=({token:e})=>{const[t,o]=i(""),[s,c]=i(!1),[l,d]=i("");async function p(e,t){try{const o=await async function(e){const t=await fetch("https://api.spotify.com/v1/me",{method:"GET",headers:{Authorization:"Bearer "+e}});if(!S.includes(t.status))throw Error("Creating new playlist was unsuccessful");return(await t.json()).id}(e),n=await B(e,"Discover Weekly"),r=await async function(e,t){const o=await fetch(t,{method:"GET",headers:{Authorization:"Bearer "+e}}),n=await o.json();if(!S.includes(o.status))throw Error("Fetching Discover weekly tracklist failed");return n.items}(e,n.tracks.href),i=await async function(e,t,o){const n=await fetch(`https://api.spotify.com/v1/users/${t}/playlists`,{method:"POST",headers:{Authorization:"Bearer "+e},body:JSON.stringify({name:o,description:"New playlist description",public:!1})});if(!S.includes(n.status))throw Error("Creating new playlist was unsuccessful");return(await n.json()).id}(e,o,t);await async function(e,t,o){const n=new URL(`https://api.spotify.com/v1/playlists/${t}/tracks`);n.searchParams.append("uris",o.join());const r=await fetch(n.toString(),{method:"POST",headers:{Authorization:"Bearer "+e}});if(!S.includes(r.status))throw Error("Adding songs failed")}(e,i,r.map((e=>e.track.uri))),c(!0)}catch(n){o=n.message,d(""),d(o)}var o}return(()=>{const i=$.cloneNode(!0);return n(i,(()=>{const i=a((()=>!s()),!0);return()=>i()?[P.cloneNode(!0),(()=>{const i=E.cloneNode(!0);return i.firstChild,i.addEventListener("submit",(o=>{o.preventDefault(),""!=t()&&p(e,t())})),n(i,r(f,{type:"text",required:!0,placeholder:"New Playlist Name",onInput:e=>{o(e.target.value)},get value(){return t()}}),null),n(i,r(m,{type:"submit",children:"Backup Now"}),null),i})()]:[j.cloneNode(!0),r(x,{children:"Discover Weekly has been saved"})]})(),null),n(i,(()=>{const e=a((()=>""!==l()),!0);return()=>e()&&r(v,{get children(){return l()}})})(),null),i})()};var _="/assets/music-note.7c6cc88d.png";const A=o('<img class="backgroundNote">'),C=o('<span class="green">PLAY</span>'),L=o('<div id="sidebar"></div>');s((()=>{const[e,t]=i("");return c((()=>{document.cookie&&""===window.location.hash&&parseInt(p.get("expiry"))>Date.now()&&t(p.get("access_token"));const e=Object.fromEntries(new URLSearchParams(document.location.hash.slice(1)).entries());e.access_token&&(t(e.access_token),p.set("access_token",e.access_token),p.set("expiry",String(Date.now()+1e3*parseInt(e.expires_in))),history.pushState("",document.title,window.location.pathname+window.location.search))})),r(d,{theme:{black:"#172228",gray:"#dadae2",green:"#1db954",secondaryGreen:"#15883e",white:"#ffffff",offWhite:"#f9f5f2",secondaryBlack:"#181818"},get children(){return[r(g,{}),r(w,{get children(){return[(()=>{const e=A.cloneNode(!0);return l(e,"src",_),e})(),(()=>{const e=A.cloneNode(!0);return l(e,"src",_),e})(),(()=>{const e=A.cloneNode(!0);return l(e,"src",_),e})(),r(y,{get children(){return["Re",C.cloneNode(!0)]}}),r(h,{get children(){return[a((()=>{const t=a((()=>""===e()),!0);return()=>t()?r(z,{}):r(D,{get token(){return e()}})})()),(()=>{const e=L.cloneNode(!0);return n(e,r(x,{children:"What is RePLAY?"}),null),n(e,r(b,{children:"Replay is a simple tool that lets you backup your discover weekly playlist at the press of a button!"}),null),n(e,r(b,{children:"For those times you find yourself frequently forgetting to listen to the whole of it and the clock is ticking towards midnight on the final day."}),null),e})()]}})]}})]}})}),document.getElementById("root"));
